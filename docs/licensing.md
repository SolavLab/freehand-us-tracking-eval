...
are too large for this repository and are published as a separate Zenodo
deposit under CC-BY-4.0, DOI 10.5281/zenodo.22690904 — a more fitting
licence for data than MIT, which is written for software. Nothing in the
paper's
